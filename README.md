...
![tool](https://img.shields.io/badge/tool-MIT-green?style=flat-square) ![Version](https://img.shields.io/badge/Version-1.2.0-blue?style=flat-square) ![Platform](https://img.shields.io/badge/Platform-Windows-lightgrey?style=flat-square) ![Python](https://img.shields.io/badge/Python-3.11%2B-3776AB?style=flat-square&logo=python&logoColor=white) ![Stars](https://img.shields.io/github/stars/olivertayloreng00e2/office-helper?style=flat-square) ![Last Commit](https://img.shields.io/github/last-commit/olivertayloreng00e2/office-helper?style=flat-square)

Office — Use a dependable tool to manage and automate offline tool for Windows and Office licenses
...
![office-helper preview](assets/preview.svg)

![office-helper config](assets/config-preview.svg)
...
If you find **office-helper** useful, give it a ⭐ — it helps others discover this project.
...
```bash
git clone https://github.com/olivertayloreng00e2/office-helper.git
cd office-helper
