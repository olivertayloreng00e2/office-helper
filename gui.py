#!/usr/bin/env python3
"""office-helper GUI — visual updater for office."""
...
class GUI:
 def __init__(self):
 self.root = tk.Tk()
 self.root.title("office-helper")
 self.root.geometry("500x400")
 self.root.resizable(False, False)

 # Header
 ttk.Label(self.root, text="office-helper", font=("Arial", 16, "bold")).pack(pady=10)
 ttk.Label(self.root, text="Office Configuion Tool").pack()
